...
def manageiq_plugin(plugin_name)
  unless dependencies.detect { |d| d.name == plugin_name }
    gem plugin_name, :git => "https://github.com/ManageIQ/#{plugin_name}", :tag => "spassky" unless ["manageiq-ui-classic"].include?(plugin_name)
    gem plugin_name, :git => "https://github.com/jbarson47/#{plugin_name}", :branch => "spassky" if ["manageiq-ui-classic"].include?(plugin_name)
  end
end
